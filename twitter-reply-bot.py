...
TWITTER_API_KEY = os.getenv("TWITTER_API_KEY", "gPpLmSvnQzwQciRFdJyW6VDp5")
TWITTER_API_SECRET = os.getenv("TWITTER_API_SECRET", "fuYCaStAiMnfQXpM7wAJHvHeJyPEuwbefwBHda8xY4BsT6RTj9")
TWITTER_ACCESS_TOKEN = os.getenv("TWITTER_ACCESS_TOKEN", "876911034979581952-fl4C6zybh1jNwUpOMEKKVQ9yWCXhQj2")
TWITTER_ACCESS_TOKEN_SECRET = os.getenv("TWITTER_ACCESS_TOKEN_SECRET", "euoBHAw8RgYWsodjGShszStevywUDqpxNUYJautfwXUiE")
TWITTER_BEARER_TOKEN = os.getenv("TWITTER_BEARER_TOKEN", "AAAAAAAAAAAAAAAAAAAAACkErwEAAAAAd1sLnwYMOzGZLCECJ5l6CWT3f5c%3DeHDjbAwAVonXCPvp6FnDrUTXUXLtXxK0SuGbulaoRUlr3MPz7I")

AIRTABLE_API_KEY = os.getenv("AIRTABLE_API_KEY", "patsnCrOILBQ2GA24.97f773cd46a4499626abdd8a8ded5fa34677b533272075864f43fcf6eb2ba7cc")
AIRTABLE_BASE_KEY = os.getenv("AIRTABLE_BASE_KEY", "appxUGjHLDfBRwbqQ")
AIRTABLE_TABLE_NAME = os.getenv("AIRTABLE_TABLE_NAME", "tblvPKOvz275atbdW")
